...
(def dicts
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :help/key-commands "Key Commands"
        :help/working-with-lists " (utiliser les listes)"
        :help/select-nfs-browser "Veuillez utiliser un autre navigateur (tel que Chrome) qui supporte les fonctions NFS pour ouvrir un dossier local."
        :undo "Annuler"
        :redo "Rétablir"
        :general "Général"
        ...
        :publishing/pages "Pages"
        :publishing/page-name "Nom de la Page"
        :publishing/current-project "Projet selectionné"
        :publishing/delete-from-logseq "Effacer du serveur Logseq"
        :publishing/edit "Editer"
        :publishing/save "Sauvegarder"
        :publishing/cancel "Annuler"
        :publishing/delete "Supprimer"
        ...
        :settings-page/developer-mode "Mode développeur"
        ...
        :my-publishing "Ma publication"
        :settings "Préférences"
        :import "Importer"
        :join-community "Rejoindre la communauté"
        :discord-title "Notre groupe Discord !"
        :sign-out "Se déconnecter"
        :help-shortcut-title "Cliquer pour voir les raccourcis et astuces "
