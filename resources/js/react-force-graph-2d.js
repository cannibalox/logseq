// Version 1.19.0 react-force-graph-2d - https://github.com/vasturiano/react-force-graph
      ...
      tickFrame: function tickFrame(state) {
        ...
        function paintArrows() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints && _construct(Bezier, [start.x, start.y].concat(_toConsumableArray$4(link.__controlPoints), [end.x, end.y]));
        ...
        function paintPhotons() {
          ...
          state.graphData.links.filter(getVisibility).forEach(function (link) {
            ...
            var bzLine = link.__controlPoints ? _construct(Bezier, [start.x, start.y].concat(_toConsumableArray$4(link.__controlPoints), [end.x, end.y])) : null;
